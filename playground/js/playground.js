...
(function (MakerJsPlayground) {
    ...
    function getProcessedModel(model) {
        return processed.model;
    }
    MakerJsPlayground.getProcessedModel = getProcessedModel;
    ...
    function setExportText(format, title, text, error) {
        console.log('Calling set export text', format, title, text, error);
        saveFile(format, text);
        //console.log('Calling setExportText');
        // if (error) {
    ...
    MakerJsPlayground.exportOnUIThread = exportOnUIThread;
    ...
    MakerJsPlayground.exportOnWorkerThread = exportOnWorkerThread;
    ...
    window.onload = function (ev) {
        ...
        MakerJsPlayground.useWorkerThreads = true; // false;// !MakerJsPlayground.querystringParams['noworker'];
